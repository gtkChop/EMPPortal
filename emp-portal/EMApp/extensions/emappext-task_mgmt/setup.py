...
setup(
    name='emappext-task_mgmt',  # Required
    version='1.0',
    description='Task management packages registration for Employee Management App',
    ...
    entry_points={
        'emapp.register': [
            'task_mgmt=emappext.task_mgmt.register:EMAppTaskManagementRegister'
        ],
    }
)
