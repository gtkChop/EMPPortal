...
class EMAppTaskManagementRegister(BaseAppCorePluginInterface, BaseAppRoutePluginInterface):
    """
    This is the task_mgmt registration process. Its is inherited from the Abstract class
    ...
    def app_schema(self, schema):
        ...
        schema_dir = "emappext.task_mgmt.schema"
