...
setup(
    name='emappext-project_mgmt',  # Required
    version='1.0',
    description='Project management packages registration for Employee Management App',
    ...
    entry_points={
        'emapp.register': [
            'project_mgmt=emappext.project_mgmt.register:EMAppProjectManagementRegister'
        ],
    }
)
