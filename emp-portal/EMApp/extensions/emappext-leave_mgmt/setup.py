...
setup(
    name='emappext-leave_mgmt',  # Required
    version='1.0',
    description='Leave management extension',
    ...
    entry_points={
        'emapp.register': [
            'hr_mgmt=emappext.hr_mgmt.register:EMAppLeaveManagementRegister'
        ],
    }
)
