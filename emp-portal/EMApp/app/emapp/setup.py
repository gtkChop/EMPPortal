...
setup(
    name='emappcore',  # Required
    version='1.0',
    description='Core packages registration for Employee Task Management App',
    ...
    classifiers=[  # Optional
        ...
        'Topic : Eployee Task Management App',
    ...
    entry_points={
        'emapp.register': [
            'emappcore=emappcore.register:EMAppCorePluginRegister'
        ],
    }
)
